    ...
    if(isset($_POST['get_all_rooms']))
    {
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            ...
            <tr class='align-middle'>
                ...
                <td>$status</td>
                <td>
                    <button type='button' onclick='edit_deatails($row[id])' class='btn btn-primary shadow-none btn-sm' data-bs-toggle='modal' data-bs-target='#edit-room'>
