...
<head>
  ...
  <title>Hương Giang Hotel - HOME </title>
...
<body class="bg-light">
  ...
  <!-- Carousel -->
  <div class="container-fluid px-l-4 mt-4">
      ...
      <div class="swiper-wrapper mb-5">
        <div class="swiper-slide bg-white p-4">
          ...
          <p>
            ...
            Deleniti voluptas soluta eaque eos neque reprehenderit dignissimos necessitatibus distinctio!
          </p>
          <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
